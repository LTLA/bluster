...
#'
#' @details
#' This function is similar to the \code{\link[igraph]{cut_at}} function from the \pkg{igraph} package,
...
#' 
#' @seealso
#' \code{\link[igraph]{cut_at}}, for a faster and more natural adjustment when using a hierarchical community detection algorithm.
#'
